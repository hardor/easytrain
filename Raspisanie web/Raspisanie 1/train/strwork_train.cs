    ...
    public class strwork_train
    {
        ...
        public void table(ListView listView2, string otprv, string nazn, string date)
        {
            ...
            while (1 > 0)
            {
                ...
                //string end_4 = @", name: '";
                //begin_zena[number] = s_train.IndexOf(begin_4, end_zena[number-1]);
                //if (begin_zena[number] < 0) { break; }
                //end_zena[number] = s_train.IndexOf(end_4, begin_zena[number]);
                //lv5.Text = s_train.Substring(begin_zena[number] + begin_4.Length, end_zena[number] - begin_zena[number] - begin_4.Length);
